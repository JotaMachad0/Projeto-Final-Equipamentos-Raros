...
@Operation(summary = "Update equipment-collaborator link",
        description = "Endpoint responsible for updating an equipment-collaborator link.",
        parameters = {
...
public @interface UpdateEquipmentCollaboratorEndpoint {
}